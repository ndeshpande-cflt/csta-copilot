#!/bin/bash
#
# start.command — runs Resource Lens in THIS Terminal window.
#
# Opened by Resource Lens.app (via `open -a Terminal`). The app runs in the
...
echo "Starting Resource Lens…  (Ctrl+C to stop)"
echo
